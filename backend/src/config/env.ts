...
const defaultNodeEnv = process.env.RENDER_SERVICE_ID ? "production" : "development";

const envSchema = z.object({
  NODE_ENV: z.preprocess((value) => value === "" ? undefined : value, z.enum(["development", "test", "production"]).default(defaultNodeEnv)),
